      ...
      <div className="sm:flex p-10 lg:p-20 md:space-x-10 mt-44">
        <div>
          ...
          <p className="text-xl ">
            ...
            and collaboration. Whether you&apos;re looking to sharpen your
            expertise or acquire new skills, our intelligent matching algorithm
            connects you with students whose strengths align with your learning
            needs, creating a dynamic, personalized learning experience.
          </p>
        </div>
